...
function start() {
    ...
    spawn_object("dresser", 70, 460, "none", "physics", "./sprites/objects/dresser_1.png", false, false, 0)
    spawn_object("dresser", 700, 460, "none", "physics", "./sprites/objects/dresser_2.png", false, false, 0)
    ...
    spawn_object("test", 800, 300, "none", "static", "./sprites/objects/test_button_1.png", true, true, 2)
